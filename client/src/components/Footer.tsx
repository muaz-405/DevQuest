        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              DevQuest is a comprehensive programming forum platform that enables developers to connect, share knowledge, and collaborate on coding challenges.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex items-start">
                ...
                <span>support@devquest.com</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>Murray College sialkot</span>
              </li>
            </ul>
