    ...
    <header className="bg-white shadow">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/">
                <div className="flex items-center space-x-2">
                  <div className="bg-gradient-to-r from-emerald-400 to-blue-500 p-2.5 rounded-lg shadow-lg">
                    <span className="text-2xl font-extrabold text-white">&lt;/&gt;</span>
                  </div>
                  <span className="text-2xl font-extrabold bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent">
                    DevQuest
                  </span>
                </div>
              </Link>
            ...
            <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link href="/features" className={`inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium ${
                location === "/features" 
                  ? "border-primary-500 text-gray-900" 
                  : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
              }`}>
      ...
      <div className={`sm:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/features" className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${
            location === "/features" 
              ? "bg-primary-50 border-primary-500 text-primary-700" 
              : "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800"
          }`}>
          ...
          <Link href="/about" className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium ${
            location === "/about" 
              ? "bg-primary-50 border-primary-500 text-primary-700" 
              : "border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800"
          }`}>
          ...
          {user ? (
            <>
              ...
              <div className="mt-3 space-y-1">
                <button
                  onClick={() => navigate("/new-thread")}
                  className="block w-full text-left px-4 py-2 text-base font-medium bg-gradient-to-r from-emerald-500 to-blue-500 text-white hover:from-emerald-600 hover:to-blue-600"
                >
                  Create Post
                </button>
                <Link href="/profile" className="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 mt-2">
                  Profile
                </Link>
                <button
