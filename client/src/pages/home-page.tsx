  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-emerald-100 rounded-full opacity-20 blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex flex-col items-center justify-center text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-2xl">
              Join these active discussions or start your own thread. Share your
              knowledge with our growing community of developers.
            </p>
          </div>
          ...
          {isLoadingThreads ? (
            ...
            <div className="relative">
              <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-white rounded-xl shadow-sm border border-gray-100">
                <div className="absolute inset-0 bg-white/40 backdrop-blur-sm rounded-xl z-0"></div>
                <div className="relative z-10">
                  <img 
                    src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2670&auto=format&fit=crop" 
                    alt="Community discussion" 
                    className="w-48 h-48 object-cover rounded-full mx-auto mb-6 border-4 border-white shadow-lg"
                  />
                  <h3 className="text-2xl font-medium text-gray-700 mb-4">
                    No discussions yet
                  </h3>
                  <p className="text-gray-500 mb-6 max-w-md mx-auto">
                    Be the first to start a meaningful discussion and help build our community of developers!
                  </p>
                  <Link
                    href="/auth?tab=register"
                    className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-lg text-white bg-gradient-to-r from-emerald-400 to-sky-500 hover:from-emerald-500 hover:to-sky-600 transition-all duration-300 hover:shadow-xl"
                  >
      ...
      <div className="py-16 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="absolute top-40 -left-24 w-96 h-96 bg-purple-100 rounded-full opacity-20 blur-3xl"></div>
        <div className="absolute bottom-40 -right-24 w-96 h-96 bg-indigo-100 rounded-full opacity-20 blur-3xl"></div>
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex flex-col items-center justify-center text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-purple-500/10 text-purple-600 font-medium text-sm mb-3">
              CODE SHARING
            </span>
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-2xl">
              Share code snippets with syntax highlighting for better
          ...
          <div className="relative mb-20">
            <div className="absolute -z-10 inset-0 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-xl transform translate-x-4 translate-y-4 opacity-50"></div>
            <img 
              src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" 
              alt="Code editor" 
              className="relative rounded-xl shadow-xl border border-gray-200 w-full h-64 object-cover"
            />
          </div>
                ...
                <div className="px-6 py-8">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-500 text-sm">
                        Responsive form layouts with Grid
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 bg-gray-50 rounded-lg p-4 overflow-auto max-h-[400px] border border-gray-100">
                ...
                <div className="px-6 py-8">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-500 text-sm">
                        Creating custom state providers
                      </p>
                    </div>
                  </div>
                  <div className="mt-4 bg-gray-50 rounded-lg p-4 overflow-auto max-h-[400px] border border-gray-100">
      ...
      <div className="py-16 bg-gradient-to-b from-white to-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-center text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-2xl">
              Find discussions in your favorite programming languages and
              topics. Join communities tailored to your interests.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <Link
              href="/categories"
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 transition-all duration-300"
            >
              View All Categories
            </Link>
          </div>
