...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden py-12 sm:py-16 lg:py-24">
      <div className="absolute inset-0">
        ...
        />
        <div className={`absolute inset-0 ${currentImage.gradient} backdrop-blur-sm`} />
      </div>
      <div className="container relative z-10 px-4 md:px-6">
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-16">
          {/* Left column - Auth forms */}
          <div className="mx-auto w-full max-w-md space-y-6">
            <Card className="mb-6 bg-gradient-to-br from-white/95 via-white/90 to-white/95 backdrop-blur-sm border-t border-white/50 shadow-xl">
              <CardHeader className="text-center space-y-2">
                ...
                <CardDescription className="text-gray-700 text-lg font-medium">
                  The programming community where knowledge is shared and
              ...
              <div className="absolute inset-0 opacity-10 w-full h-full bg-white">
                <div className="grid grid-cols-4 gap-4 p-4">
                  {[...Array(20)].map((_, i) => (
                    <div
                      key={i}
                      className="h-16 w-full border border-white/20 rounded"
                    ></div>
                  ))}
                </div>
              </div>
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-primary-100">
                      <strong className="text-white">Share code</strong> with
                      syntax highlighting
                    </p>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-primary-100">
                      <strong className="text-white">Participate</strong> in
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="ml-3 text-primary-100">
                      <strong className="text-white">Stay updated</strong> with
